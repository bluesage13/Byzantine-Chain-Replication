# -*- generated by 1.0.9 -*-
import da
PatternExpr_903 = da.pat.ConstantPattern('get_public_key_maps')
PatternExpr_907 = da.pat.FreePattern('p_id')
PatternExpr_941 = da.pat.TuplePattern([da.pat.ConstantPattern('getConfig'), da.pat.FreePattern('p')])
PatternExpr_948 = da.pat.FreePattern('client_id')
PatternExpr_982 = da.pat.ConstantPattern('generate_keys')
PatternExpr_986 = da.pat.FreePattern('client_id')
PatternExpr_1036 = da.pat.ConstantPattern('get_chain_info')
PatternExpr_1040 = da.pat.FreePattern('replica_id')
PatternExpr_1162 = da.pat.TuplePattern([da.pat.ConstantPattern('wedged_reply'), da.pat.FreePattern('rid'), da.pat.FreePattern('hist'), da.pat.FreePattern('cp')])
PatternExpr_1173 = da.pat.FreePattern('p_id')
PatternExpr_1200 = da.pat.TuplePattern([da.pat.ConstantPattern('reconfiguration'), da.pat.FreePattern('cc')])
PatternExpr_1206 = da.pat.FreePattern('p_id')
_config_object = {}
import time
import sys
import logging
...
class Olympus(da.DistProcess):
    ...
    def __init__(self, procimpl, props):
        ...
        self._events.extend([da.pat.EventPattern(da.pat.ReceivedEvent, '_OlympusReceivedEvent_0', PatternExpr_903, sources=[PatternExpr_907], destinations=None, timestamps=None, record_history=None, handlers=[self._Olympus_handler_902]), da.pat.EventPattern(da.pat.ReceivedEvent, '_OlympusReceivedEvent_1', PatternExpr_941, sources=[PatternExpr_948], destinations=None, timestamps=None, record_history=None, handlers=[self._Olympus_handler_940]), da.pat.EventPattern(da.pat.ReceivedEvent, '_OlympusReceivedEvent_2', PatternExpr_982, sources=[PatternExpr_986], destinations=None, timestamps=None, record_history=None, handlers=[self._Olympus_handler_981]), da.pat.EventPattern(da.pat.ReceivedEvent, '_OlympusReceivedEvent_3', PatternExpr_1036, sources=[PatternExpr_1040], destinations=None, timestamps=None, record_history=None, handlers=[self._Olympus_handler_1035]), da.pat.EventPattern(da.pat.ReceivedEvent, '_OlympusReceivedEvent_4', PatternExpr_1162, sources=[PatternExpr_1173], destinations=None, timestamps=None, record_history=None, handlers=[self._Olympus_handler_1161]), da.pat.EventPattern(da.pat.ReceivedEvent, '_OlympusReceivedEvent_5', PatternExpr_1200, sources=[PatternExpr_1206], destinations=None, timestamps=None, record_history=None, handlers=[self._Olympus_handler_1199])])

    def setup(self, conf, cni, fc, cc, **rest_1455):
        super().setup(conf=conf, cni=cni, fc=fc, cc=cc, **rest_1455)
        ...
        self._state.failureCases = self._state.fc
    ...
    def run(self):
        ...
        while True:
            ...
            if (_st_label_346 != 2):
                break
            super()._label('_st_label_353', block=False)
            _st_label_353 = 0
            while (_st_label_353 == 0):
                _st_label_353 += 1
                if (len(self._state.wedged_replies) == len(self._state.replicas)):
                    _st_label_353 += 1
                else:
                    super()._label('_st_label_353', block=True)
                    _st_label_353 -= 1
            else:
                if (_st_label_353 != 2):
                    continue
            ...
            self._state.logger.info(((((str(self._id) + ' Highest slot ') + str(h_slot)) + 'seen by replica : ') + str(h_s_rep)))
            break
    ...
    def create_replicas(self):
        ...
        for r in self._state.replicas:
            ...
            if (cnt == 0):
                if (cnt in self._state.failureCases):
                    self._setup(r, (self._state.conf, True, False, pri_key, self._state.cni, self._state.failureCases[cnt], self._state.curr_config, self._id))
                else:
                    self._setup(r, (self._state.conf, True, False, pri_key, self._state.cni, None, self._state.curr_config, self._id))
            elif (cnt == (len(self._state.replicas) - 1)):
                if (cnt in self._state.failureCases):
                    self._setup(r, (self._state.conf, False, True, pri_key, self._state.cni, self._state.failureCases[cnt], self._state.curr_config, self._id))
                else:
                    self._setup(r, (self._state.conf, False, True, pri_key, self._state.cni, None, self._state.curr_config, self._id))
            elif (cnt in self._state.failureCases):
                self._setup(r, (self._state.conf, False, False, pri_key, self._state.cni, self._state.failureCases[cnt], self._state.curr_config, self._id))
            else:
                self._setup(r, (self._state.conf, False, False, pri_key, self._state.cni, None, self._state.curr_config, self._id))
            self._start(r)
            cnt = (cnt + 1)

    def _Olympus_handler_902(self, p_id):
    ...
    _Olympus_handler_902._labels = None
    _Olympus_handler_902._notlabels = None

    def _Olympus_handler_940(self, p, client_id):
    ...
    _Olympus_handler_940._labels = None
    _Olympus_handler_940._notlabels = None

    def _Olympus_handler_981(self, client_id):
    ...
    _Olympus_handler_981._labels = None
    _Olympus_handler_981._notlabels = None

    def _Olympus_handler_1035(self, replica_id):
    ...
    _Olympus_handler_1035._labels = None
    _Olympus_handler_1035._notlabels = None

    def _Olympus_handler_1161(self, rid, hist, cp, p_id):
        self._state.logger.info(((str(self._id) + ' received wedged reply from ') + str(p_id)))
        self._state.wedged_replies[rid] = [hist, cp]
    _Olympus_handler_1161._labels = None
    _Olympus_handler_1161._notlabels = None

    def _Olympus_handler_1199(self, cc, p_id):
    ...
    _Olympus_handler_1199._labels = None
    _Olympus_handler_1199._notlabels = None
